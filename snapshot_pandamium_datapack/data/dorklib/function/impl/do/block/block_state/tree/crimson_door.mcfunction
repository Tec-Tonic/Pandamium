...
execute if block ~ ~ ~ crimson_door[half=upper] run data modify storage do:io output.Properties.half set value "upper"
execute if block ~ ~ ~ crimson_door[hinge=right] run data modify storage do:io output.Properties.hinge set value "right"
execute if block ~ ~ ~ crimson_door[open=true] run data modify storage do:io output.Properties.open set value "true"
execute if block ~ ~ ~ crimson_door[powered=true] run data modify storage do:io output.Properties.powered set value "true"
