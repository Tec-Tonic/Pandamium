...
execute if block ~ ~ ~ oak_fence_gate[in_wall=true] run data modify storage do:io output.Properties.in_wall set value "true"
execute if block ~ ~ ~ oak_fence_gate[open=true] run data modify storage do:io output.Properties.open set value "true"
execute if block ~ ~ ~ oak_fence_gate[powered=true] run data modify storage do:io output.Properties.powered set value "true"
