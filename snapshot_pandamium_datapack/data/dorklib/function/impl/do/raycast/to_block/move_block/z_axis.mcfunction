...
execute if score #L_z dorklib.var > #max_lambda dorklib.var run return run function dorklib:impl/do/raycast/to_block/final_destination/exceeded_max_distance
...
execute if score #d_z dorklib.var matches 1.. run scoreboard players set #edge_facing dorklib.var 2
execute if score #d_z dorklib.var matches 1.. run scoreboard players add #b_z dorklib.var 1
execute if score #d_z dorklib.var matches 1.. positioned ~ ~ ~1 run return run function dorklib:impl/do/raycast/to_block/loop with storage dorklib:main functions."do:raycast/to_block"
execute if score #d_z dorklib.var matches ..-1 run scoreboard players set #edge_facing dorklib.var 3
