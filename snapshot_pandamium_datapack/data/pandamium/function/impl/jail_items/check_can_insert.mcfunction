...
item modify block 2 0 0 container.0 {type:"minecraft:set_count",count:{type:"minecraft:score",target:{type:"minecraft:fixed",name:"<items_remaining>"},score:"variable"}}
