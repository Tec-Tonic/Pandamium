...
scoreboard players set @s custom_dye.biome_id 7
scoreboard players set @s custom_dye.color_transition.target_red 148
scoreboard players set @s custom_dye.color_transition.target_green 24
scoreboard players set @s custom_dye.color_transition.target_blue 24
