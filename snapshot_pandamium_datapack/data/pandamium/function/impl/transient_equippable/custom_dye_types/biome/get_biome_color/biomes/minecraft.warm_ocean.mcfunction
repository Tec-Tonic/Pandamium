...
scoreboard players set @s custom_dye.biome_id 58
scoreboard players set @s custom_dye.color_transition.target_red 67
scoreboard players set @s custom_dye.color_transition.target_green 213
scoreboard players set @s custom_dye.color_transition.target_blue 238
