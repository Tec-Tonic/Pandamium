...
scoreboard players set @s custom_dye.biome_id 47
scoreboard players set @s custom_dye.color_transition.target_red 240
scoreboard players set @s custom_dye.color_transition.target_green 253
scoreboard players set @s custom_dye.color_transition.target_blue 253
