...
scoreboard players set @s custom_dye.biome_id 51
scoreboard players set @s custom_dye.color_transition.target_red 127
scoreboard players set @s custom_dye.color_transition.target_green 127
scoreboard players set @s custom_dye.color_transition.target_blue 127
