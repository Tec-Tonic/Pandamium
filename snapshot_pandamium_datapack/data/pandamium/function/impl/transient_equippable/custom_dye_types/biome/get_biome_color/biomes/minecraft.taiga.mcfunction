...
scoreboard players set @s custom_dye.biome_id 55
scoreboard players set @s custom_dye.color_transition.target_red 104
scoreboard players set @s custom_dye.color_transition.target_green 164
scoreboard players set @s custom_dye.color_transition.target_blue 100
