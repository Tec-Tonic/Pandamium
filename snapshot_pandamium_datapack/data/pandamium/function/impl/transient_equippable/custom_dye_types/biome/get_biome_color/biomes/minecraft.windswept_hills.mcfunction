...
scoreboard players set @s custom_dye.biome_id 62
scoreboard players set @s custom_dye.color_transition.target_red 109
scoreboard players set @s custom_dye.color_transition.target_green 163
scoreboard players set @s custom_dye.color_transition.target_blue 107
