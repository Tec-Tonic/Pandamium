...
scoreboard players set @s custom_dye.biome_id 27
scoreboard players set @s custom_dye.color_transition.target_red 128
scoreboard players set @s custom_dye.color_transition.target_green 180
scoreboard players set @s custom_dye.color_transition.target_blue 151
