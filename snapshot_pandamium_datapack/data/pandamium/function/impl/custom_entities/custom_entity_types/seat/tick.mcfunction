execute unless predicate {type:"minecraft:entity_properties",entity:"this",predicate:{predicates:{"minecraft:custom_data":{enforced_sit:"1b"}}}} run function pandamium:impl/custom_entities/custom_entity_types/seat/enforce_sit
