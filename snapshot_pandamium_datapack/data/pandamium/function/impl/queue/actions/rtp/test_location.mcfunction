...
execute positioned over motion_blocking_no_leaves if block ~ ~-1 ~ snow_block if predicate {type:"minecraft:location_check",offsetY:-1,predicate:{structures:"minecraft:village_snowy"}} run return 0
execute positioned over motion_blocking_no_leaves if predicate {type:"minecraft:location_check",predicate:{structures:"minecraft:pillager_outpost"}} run return 0
# success
