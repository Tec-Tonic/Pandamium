...
# end
$execute if score <result> variable matches 0 run tellraw @a[scores={id=$(user_id)},limit=1] [{text:"[Info]",color:"dark_red"},{text:" Iteraction limit exceeded! If this issue continues to occur, let a staff member know.",color:"red"}]
