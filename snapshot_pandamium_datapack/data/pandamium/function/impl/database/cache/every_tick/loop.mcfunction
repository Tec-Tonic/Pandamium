...
execute if data storage pandamium:temp entries[-1].username unless data storage pandamium:temp entries[-1].remove run function pandamium:impl/database/cache/every_tick/try_select_player with storage pandamium:temp entries[-1]
