...
# initialise entry
$data modify storage pandamium:local functions."pandamium:impl/database/cache/modify/add_projectile_trail_entry/*".entry set value {uuid:"$(uuid)",id:"$(uuid)-trail",commands:['particle minecraft:block_marker{block_state:{id:"minecraft:test_block",properties:{mode:"fail"}}}','','']}
