data modify storage pandamium:temp cheat_data set value {type:"unknown",name:"Unknown",return_to_start:true}
...
execute if entity @s[advancements={pandamium:detect/parkour/cheat={switch_gamemode=true}}] run data modify storage pandamium:temp cheat_data merge value {type:"switch_gamemode",name:"Switching to an invalid gamemode",return_to_start:false}
execute if entity @s[advancements={pandamium:detect/parkour/cheat={leave_course=true}}] run data modify storage pandamium:temp cheat_data merge value {type:"leave_course",name:"Leaving the course",return_to_start:false}
...
execute if entity @s[advancements={pandamium:detect/parkour/cheat={teleport=true}}] run data modify storage pandamium:temp cheat_data merge value {type:"teleport",name:"Teleporting",return_to_start:false}
