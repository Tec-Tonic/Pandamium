...
execute if score <checkpoint> variable matches 300..399 in pandamium:hub positioned -300.5 136 197.0 rotated 0 0 run function pandamium:utils/teleport/here
