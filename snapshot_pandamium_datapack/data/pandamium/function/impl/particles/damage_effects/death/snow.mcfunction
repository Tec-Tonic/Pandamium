execute anchored eyes rotated 0 0 run particle minecraft:block{block_state:"minecraft:ice"} ^ ^-0.5 ^ 0.1 0.5 0.1 1 20
execute anchored eyes rotated 0 0 run particle minecraft:block{block_state:"minecraft:snow_block"} ^ ^-0.5 ^ 0.1 0.5 0.1 1 15
