# rtp
execute as @a[x=-291,y=128,z=183,dx=4,dy=4,dz=0,gamemode=!spectator] unless score @s rtp_cooldown matches 1.. run function pandamium:misc/rtp
# map-art teleport
...
# nether portal
execute as @a[x=-255,y=136,z=166,dx=0,dy=4,dz=4] run function pandamium:misc/warp/nether_spawn
# end portal
