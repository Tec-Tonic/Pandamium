...
item modify block 5 0 0 contents {type:"minecraft:set_name",entity:"this",name:{storage:"pandamium:local",nbt:"functions.'pandamium:triggers/namehome/*'.text",interpret:true}}
