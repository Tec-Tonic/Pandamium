...
tellraw @a [{text:"[Info]",color:"blue"},{text:" The server restart was ",color:"green",extra:[{text:"cancelled",color:"aqua"},"!"]}]
function pandamium:utils/log {args:{message:'event="server_restart_cancelled"'}}
