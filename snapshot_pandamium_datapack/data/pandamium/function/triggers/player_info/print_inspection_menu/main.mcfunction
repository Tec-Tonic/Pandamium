...
# last known position
$execute if predicate pandamium:player/min_staff_perms/moderator run execute store result score <dimension> variable run scoreboard players get $(username) last_position.d
execute if predicate pandamium:player/min_staff_perms/moderator run function pandamium:utils/get/dimension_name/from_score
$execute if predicate pandamium:player/min_staff_perms/moderator run execute if score $(username) last_position.y matches -2147483648.. run tellraw @s [{text:" last_position: ",color:"gold"},{text:"[👁]",color:"dark_gray",hover_event:{action:"show_text",value:[{text:"",color:"gold"},{score:{name:"$(username)",objective:"last_position.x"},color:"yellow",extra:[" ",{score:{name:"$(username)",objective:"last_position.y"}}," ",{score:{name:"$(username)",objective:"last_position.z"}}]}," in ",{nbt:"dimension_name",storage:"pandamium:temp",interpret:true,color:"yellow"}]}}," ",{text:"[→]",color:"blue",hover_event:{action:"show_text",value:[{text:"Click to teleport to ",color:"blue"},{storage:"pandamium:temp",nbt:"target",interpret:true},"'s last position"]},click_event:{action:"run_command",command:"trigger tp set $(id)"}}," ",{text:"[🔙]",color:"red",hover_event:{action:"show_text",value:[{text:"Click to teleport ",color:"red"},{storage:"pandamium:temp",nbt:"target",interpret:true}," to spawn and reset their ",{text:"spawnpoint",bold:true},{text:"\nIf they are offline, they will\nbe teleported when they next\njoin the server.",color:"gray"}]},click_event:{action:"run_command",command:"trigger player_info set -9$(id_with_leading_zeroes)"}}]
$execute if predicate pandamium:player/min_staff_perms/moderator run execute unless score $(username) last_position.y matches -2147483648.. run tellraw @s [{text:" last_position: ",color:"gold"},{text:"Unknown",color:"gray"}," ",{text:"[🔙]",color:"red",hover_event:{action:"show_text",value:[{text:"Click to teleport ",color:"red"},{storage:"pandamium:temp",nbt:"target",interpret:true}," to spawn",{text:"\nIf they are offline, they will\nbe teleported when they next\njoin the server.",color:"gray"}]},click_event:{action:"run_command",command:"trigger player_info set -9$(id_with_leading_zeroes)"}}]
# used y here because some players' last_position.x were accidentally set to 0 when they should be unset
# last set spawnpoint
$execute if predicate pandamium:player/min_staff_perms/moderator run scoreboard players operation <dimension> variable = $(username) spawnpoint_d
execute if predicate pandamium:player/min_staff_perms/moderator run function pandamium:utils/get/dimension_name/from_score
$execute if predicate pandamium:player/min_staff_perms/moderator run execute if score $(username) spawnpoint_x matches -2147483648.. run tellraw @s [{text:" last_set_spawnpoint: ",color:"gold"},{text:"[👁]",color:"dark_gray",hover_event:{action:"show_text",value:[{text:"",color:"gold"},{score:{name:"$(username)",objective:"spawnpoint_x"},color:"yellow",extra:[" ",{score:{name:"$(username)",objective:"spawnpoint_y"}}," ",{score:{name:"$(username)",objective:"spawnpoint_z"}}]}," in ",{nbt:"dimension_name",storage:"pandamium:temp",interpret:true,color:"yellow"}]}}," ",{text:"[→]",color:"blue",hover_event:{action:"show_text",value:[{text:"Click to teleport to ",color:"blue"},{storage:"pandamium:temp",nbt:"target",interpret:true},"'s ",{text:"spawnpoint",bold:true}]},click_event:{action:"run_command",command:"trigger spawnpoint set -$(id)"}}]
# pre-jail position
$execute if predicate pandamium:player/min_staff_perms/moderator run execute store result score <dimension> variable run scoreboard players get $(username) pre_jail_pos_d
execute if predicate pandamium:player/min_staff_perms/moderator run function pandamium:utils/get/dimension_name/from_score
$execute if predicate pandamium:player/min_staff_perms/moderator run execute if score $(username) pre_jail_pos_x matches -2147483648.. run tellraw @s [{text:" pre_jail_position: ",color:"gold"},{text:"[👁]",color:"dark_gray",hover_event:{action:"show_text",value:[{text:"",color:"gold"},{score:{name:"$(username)",objective:"pre_jail_pos_x"},color:"yellow",extra:[" ",{score:{name:"$(username)",objective:"pre_jail_pos_y"}}," ",{score:{name:"$(username)",objective:"pre_jail_pos_z"}}]}," in ",{nbt:"dimension_name",storage:"pandamium:temp",interpret:true,color:"yellow"}]}}," ",{text:"[→]",color:"blue",hover_event:{action:"show_text",value:[{text:"Click to teleport to ",color:"blue"},{storage:"pandamium:temp",nbt:"target",interpret:true},"'s pre-jail position"]},click_event:{action:"run_command",command:"trigger pre_jail_tp set $(id)"}}]
# last death location
execute if predicate pandamium:player/min_staff_perms/moderator run execute if score <target_is_online> variable matches 1 run data modify storage pandamium:local functions."pandamium:triggers/player_info/print_inspection_menu/*".last_death_location set from entity @a[predicate=pandamium:matches_id,limit=1] LastDeathLocation
execute if predicate pandamium:player/min_staff_perms/moderator run function pandamium:utils/get/dimension_name/from_string_id with storage pandamium:local functions."pandamium:triggers/player_info/print_inspection_menu/*".last_death_location
$execute if predicate pandamium:player/min_staff_perms/moderator run execute if score <target_is_online> variable matches 1 run tellraw @s [{text:" last_death_location: ",color:"gold"},{text:"[👁]",color:"dark_gray",hover_event:{action:"show_text",value:[{text:"",color:"gold"},{storage:"pandamium:local",nbt:"functions.'pandamium:triggers/player_info/print_inspection_menu/*'.last_death_location.pos[]",separator:" ",color:"yellow"}," in ",{nbt:"dimension_name",storage:"pandamium:temp",interpret:true,color:"yellow"}]}}," ",{text:"[→]",color:"blue",hover_event:{action:"show_text",value:[{text:"Click to teleport to ",color:"blue"},{storage:"pandamium:temp",nbt:"target",interpret:true},"'s ",{text:"last death location",bold:true}]},click_event:{action:"run_command",command:"trigger player_info set -8$(id_with_leading_zeroes)"}}]
# first join date
...
data modify storage pandamium:temp month_name set string storage pandamium:temp month_name 0 3
function pandamium:utils/datetime/get_datetime_text {args:_}
$execute if score $(username) last_joined.datetime = $(username) last_joined.datetime run tellraw @s [{text:" last_join_date: ",color:"gold"},{storage:"pandamium:temp",nbt:"month_name",interpret:true,color:"yellow",extra:[" ",{score:{name:"<year>",objective:"variable"}}]}," ",{text:"[⌚]",color:"dark_gray",hover_event:{action:"show_text",value:{color:"yellow",storage:"pandamium:temp",nbt:"datetime_text.date_time",interpret:true}}}]
# alt information
execute if predicate pandamium:player/min_staff_perms/moderator run data modify storage pandamium:local functions."pandamium:triggers/player_info/print_inspection_menu/*".alt_ids set from storage pandamium.db.players:io selected.entry.data.alts
execute if predicate pandamium:player/min_staff_perms/moderator run data modify storage pandamium:local functions."pandamium:triggers/player_info/print_inspection_menu/*".alt_names set value []
execute if predicate pandamium:player/min_staff_perms/moderator run execute if data storage pandamium:local functions."pandamium:triggers/player_info/print_inspection_menu/*".alt_ids[0] in pandamium:staff_world run function pandamium:triggers/player_info/print_inspection_menu/alts_loop with storage pandamium:local functions."pandamium:triggers/player_info/print_inspection_menu/*".alt_ids[0]
execute if predicate pandamium:player/min_staff_perms/moderator run execute if data storage pandamium:local functions."pandamium:triggers/player_info/print_inspection_menu/*".alt_names[0] run tellraw @s [{text:" known_alts: ",color:"gold"},{text:"",color:"yellow",extra:[{storage:"pandamium:local",nbt:"functions.'pandamium:triggers/player_info/print_inspection_menu/*'.alt_names[]",interpret:true,separator:{text:", ",color:"gray"}}]}]
execute if predicate pandamium:player/min_staff_perms/moderator run execute if data storage pandamium.db.players:io selected.entry.data.alt_of in pandamium:staff_world run function pandamium:triggers/player_info/print_inspection_menu/get_alt_of with storage pandamium.db.players:io selected.entry.data.alt_of
execute if predicate pandamium:player/min_staff_perms/moderator run execute if data storage pandamium.db.players:io selected.entry.data.alt_of run tellraw @s [{text:" alt_of: ",color:"gold"},{text:"",color:"yellow",extra:[{storage:"pandamium:local",nbt:"functions.'pandamium:triggers/player_info/print_inspection_menu/*'.display_alt_of",interpret:true}]}]
# teleport history
$execute if predicate pandamium:player/min_staff_perms/moderator run tellraw @s [{text:" tp_history: ",color:"gold"},{text:"[👁]",color:"blue",hover_event:{action:"show_text",value:[{text:"Click to see ",color:"blue"},{storage:"pandamium:temp",nbt:"target",interpret:true},"'s ",{text:"Teleport History",bold:true}]},click_event:{action:"run_command",command:"trigger player_info set -1$(id_with_leading_zeroes)"}}]
# inventory
