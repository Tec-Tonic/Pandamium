...
tellraw @s[predicate=!pandamium:player/min_staff_perms/moderator] [{text:"• ",color:"gray"},{storage:"pandamium:temp",nbt:"entries[0].source",interpret:true,color:"white",font:"minecraft:uniform",hover_event:{action:"show_text",value:[{text:"unformatted entry data:\n",color:"gray"},{storage:"pandamium:temp",nbt:"entries[0]",color:"white"},{text:"\nunformatted date:\n",color:"gray"},{storage:"pandamium:temp",nbt:"date",interpret:true,color:"white"}]}},{text:" "},{text:"[FROM]",color:"yellow",hover_event:{action:"show_text",value:[{storage:"pandamium:temp",nbt:"entries[0].from[]",separator:" ",color:"yellow"},{text:" in "},{storage:"pandamium:temp",nbt:"from_dimension",interpret:true}]}},{text:" "},{text:"[TO]",color:"green",hover_event:{action:"show_text",value:[{storage:"pandamium:temp",nbt:"entries[0].to[]",separator:" ",color:"green"},{text:" in "},{storage:"pandamium:temp",nbt:"to_dimension",interpret:true}]}}]
tellraw @s[predicate=pandamium:player/min_staff_perms/moderator] [{text:"• ",color:"gray"},{storage:"pandamium:temp",nbt:"entries[0].source",interpret:true,color:"white",font:"minecraft:uniform",hover_event:{action:"show_text",value:[{text:"unformatted entry data:\n",color:"gray"},{storage:"pandamium:temp",nbt:"entries[0]",color:"white"},{text:"\nunformatted date:\n",color:"gray"},{storage:"pandamium:temp",nbt:"date",interpret:true,color:"white"}]}},{text:" "},{storage:"pandamium:temp",nbt:"from_click_event",interpret:true,extra:[{text:"[FROM]",color:"yellow",hover_event:{action:"show_text",value:[{storage:"pandamium:temp",nbt:"entries[0].from[]",separator:" ",color:"yellow"},{text:" in "},{storage:"pandamium:temp",nbt:"from_dimension"},{text:"\n\nClick to teleport there"}]}}]},{text:" "},{storage:"pandamium:temp",nbt:"to_click_event",interpret:true,extra:[{text:"[TO]",color:"green",hover_event:{action:"show_text",value:[{storage:"pandamium:temp",nbt:"entries[0].to[]",separator:" ",color:"green"},{text:" in "},{storage:"pandamium:temp",nbt:"to_dimension",interpret:true},{text:"\n\nClick to teleport there"}]}}]}]
