...
execute if predicate pandamium:entity/is_baby_mob run return run tellraw @a[limit=1,tag=edit_entity.player] [{color:"dark_red",text:"[Edit Entity]"},{color:"red",text:" That is not a valid option! You cannot mount baby mobs."}]
