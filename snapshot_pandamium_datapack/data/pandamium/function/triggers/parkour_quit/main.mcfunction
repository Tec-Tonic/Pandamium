...
execute if score @s parkour.checkpoint matches 200..299 in pandamium:hub positioned -292.5 128.0 153.5 rotated 0 0 run function pandamium:utils/teleport/here
