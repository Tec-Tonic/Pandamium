...
execute in pandamium:staff_world run item modify block 5 0 0 contents {type:"minecraft:set_name",entity:"this",name:{storage:"pandamium:temp",nbt:"text",interpret:true}}
# check difference
