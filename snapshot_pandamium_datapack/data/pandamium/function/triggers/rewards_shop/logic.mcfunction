...
execute if score @s rewards_shop matches 102 run return run function pandamium:utils/show_dialog with storage pandamium:rewards_shop dialogs.autumn_drop_2026
# rewards
