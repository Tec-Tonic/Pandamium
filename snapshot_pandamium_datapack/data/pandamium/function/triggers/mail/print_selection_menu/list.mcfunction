...
execute unless predicate pandamium:player/min_staff_perms/helper run tellraw @s [" ",{text:"[Mail the Staff Team]",color:"yellow",hover_event:{action:"show_text",value:[{text:"Click to send mail to\n",color:"yellow"},{text:"The Staff Team",bold:true}]},click_event:{action:"run_command",command:"trigger mail set 1000201"}}]
execute if predicate pandamium:player/min_staff_perms/helper run tellraw @s [" ",{text:"[Mail the Staff Team]",color:"gray",hover_event:{action:"show_text",value:[{text:"Use the staff channels on the Discord server",color:"gray"}]}}]
execute if predicate pandamium:player/min_staff_perms/admin run tellraw @s [" ",{text:"[Create a News Post]",color:"#00AA7F",hover_event:{action:"show_text",value:[{text:"Click to send mail to\n",color:"#00AA7F"},{text:"News Feed",bold:true}]},click_event:{action:"run_command",command:"trigger mail set 1000202"}}]
