...
execute if score <receiver_type_is_staff> variable matches 1 if predicate pandamium:player/min_staff_perms/helper run scoreboard players set <has_access> variable 1
