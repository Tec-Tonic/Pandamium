...
execute if data storage pandamium.db.mail:io selected.entry.data.title run tellraw @s [{text:""},{text:"Title: ",color:"gray"},{storage:"pandamium:temp",nbt:"display_title",interpret:true,underlined:true}]
execute if data storage pandamium.db.mail:io selected.entry.data.message run tellraw @s [{text:""},{text:"Message:\n",color:"gray"},{storage:"pandamium.db.mail:io",nbt:"selected.entry.data.message",interpret:true}]
...
execute if score <receiver_type_is_news_feed> variable matches 0 run tellraw @s ["",{text:"From: ",color:"gray"},{text:"",color:"aqua",extra:[{storage:"pandamium:temp",nbt:"sender_display_name",interpret:true}]}," ",{text:"[⌚]",color:"dark_gray",hover_event:{action:"show_text",value:["Sent ",{storage:"pandamium:temp",nbt:"time_phrase",interpret:true}]}}]
execute if score <receiver_type_is_news_feed> variable matches 0 unless data storage pandamium:temp {receiver_display_name:{text:"You"}} run tellraw @s [{text:""},{text:"To: ",color:"gray"},{text:"",color:"aqua",extra:[{storage:"pandamium:temp",nbt:"receiver_display_name",interpret:true}]}]
execute if score <has_attached_items> variable matches 1 if score <has_available_attached_items> variable matches 1 run tellraw @s ["",{text:"Attachments: ",color:"gray"},{storage:"pandamium:temp",nbt:"take_incoming_items_click_event_root",interpret:true,extra:[{text:"[Take Attached Items]",color:"blue",hover_event:{action:"show_text",value:[{text:"Click to take the attached items from this mail",color:"blue"}]}}]},{storage:"pandamium:temp",nbt:"attached_items[{__viewable__:1b}].name",interpret:true,separator:{text:"\n• ",color:"gray"}}]
...
execute if score <mail_is_ephemeral> variable matches 1 if score <has_available_attached_items> variable matches 0 run tellraw @s ["\n",{storage:"pandamium:temp",nbt:"delete_ephemeral_mail_click_event_root",interpret:true,extra:[{text:"[Delete This Mail]",color:"#7AA4BB",hover_event:{action:"show_text",value:[{text:"Click to delete this mail",color:"#7AA4BB"}]}}]}]
