...
data modify storage pandamium.db.mail:io selected.entry.data.message set value "Your inventory was too full to unequip the item or items that you were wearing.\n\nThe item or items have been safely moved here for you to reclaim later."
