...
execute if data storage pandamium.db.mail:io selected.entry{draft:1b} run return fail
# set "saved as draft"
data modify storage pandamium.db.mail:io selected.entry.draft set value 1b
## Sender
# load from id
...
data modify storage pandamium.db.players:io selected.entry.data.mail.drafts[-1].mail_id set from storage pandamium.db.mail:io selected.entry.mail_id
