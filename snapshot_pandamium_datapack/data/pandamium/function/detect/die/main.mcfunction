...
execute if entity @s[scores={particles_data.damage_effect.type=1..},gamemode=!spectator,predicate=!pandamium:player/is_hidden] run function pandamium:impl/particles/damage_effects/on_death
