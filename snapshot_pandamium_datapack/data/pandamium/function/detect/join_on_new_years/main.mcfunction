...
tellraw @s [{text:"[Pandamium]",color:"blue"},{text:" Thank you, ",color:"green",extra:[{storage:"pandamium:temp",nbt:"username",interpret:true},", for playing on our server! The Pandamium team wishes you a ",{text:"Happy New Year ❤",color:"aqua"},"!"]}]
