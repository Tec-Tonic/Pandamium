execute unless items entity @s container.* *[enchantments~[{enchantments:"pandamium:bedrock_breaker"}],!custom_data~{pandamium:{id:"bedrock_breaker",version:2}}] \
        ...
        unless items entity @s container.* *[enchantments~[{enchantments:"pandamium:bedrock_breaker"}],!minecraft:max_damage=50] \
        unless items entity @s weapon.offhand *[enchantments~[{enchantments:"pandamium:bedrock_breaker"}],!minecraft:max_damage=50] \
        unless items entity @s armor.* *[enchantments~[{enchantments:"pandamium:bedrock_breaker"}],!minecraft:max_damage=50] \
        unless items entity @s player.cursor *[enchantments~[{enchantments:"pandamium:bedrock_breaker"}],!minecraft:max_damage=50] \
        unless items entity @s player.crafting.* *[enchantments~[{enchantments:"pandamium:bedrock_breaker"}],!minecraft:max_damage=50] \
