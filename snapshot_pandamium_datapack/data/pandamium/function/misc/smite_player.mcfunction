...
execute store result score <gamerule.show_death_messages> variable run gamerule show_death_messages
gamerule show_death_messages false
$kill $(username)
execute if score <gamerule.show_death_messages> variable matches 1 run gamerule show_death_messages true
