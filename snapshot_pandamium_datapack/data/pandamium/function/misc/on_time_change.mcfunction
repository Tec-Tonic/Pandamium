...
execute if score <month> global matches 12 if score <day> global matches 31 if score <hour> global matches 0 run advancement grant @a only pandamium:pandamium/events/new_years
# custom effects
