...
function pandamium:utils/log {args:{message:['event="joined_while_jailed",data={"username":"',{storage:"pandamium:temp",nbt:"username",interpret:true},'","last_jailed_datetime":"',{score:{name:"@s",objective:"last_jailed.datetime"}},'"}']}}
# inform jailee
