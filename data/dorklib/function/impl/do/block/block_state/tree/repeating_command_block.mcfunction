...
execute if block ~ ~ ~ repeating_command_block[facing=west] run data modify storage do:io output.Properties.facing set value "west"
execute if block ~ ~ ~ repeating_command_block[facing=up] run data modify storage do:io output.Properties.facing set value "up"
execute if block ~ ~ ~ repeating_command_block[facing=down] run data modify storage do:io output.Properties.facing set value "down"
