...
execute if block ~ ~ ~ waxed_exposed_copper_door[half=upper] run data modify storage do:io output.Properties.half set value "upper"
execute if block ~ ~ ~ waxed_exposed_copper_door[hinge=right] run data modify storage do:io output.Properties.hinge set value "right"
execute if block ~ ~ ~ waxed_exposed_copper_door[open=true] run data modify storage do:io output.Properties.open set value "true"
execute if block ~ ~ ~ waxed_exposed_copper_door[powered=true] run data modify storage do:io output.Properties.powered set value "true"
