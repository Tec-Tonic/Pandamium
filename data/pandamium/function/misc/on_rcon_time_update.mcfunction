...
tellraw @a[scores={send_extra_debug_info=2..}] [{text:"[Pandamium: Time estimation was ",color:"gray",italic:true},{storage:"pandamium:temp",nbt:"seconds_behind",interpret:true}," seconds behind since the last RCON time change]"]
