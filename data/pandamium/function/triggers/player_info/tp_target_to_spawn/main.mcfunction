execute if score <target_is_online> variable matches 0 run return run function pandamium:triggers/player_info/tp_target_to_spawn/offline with storage pandamium:temp arguments
