...
execute if score <player_exists> variable matches 0 run return run tellraw @s [{text:"[Guidebook]",color:"dark_red"},{text:" Could not find a player with ID ",color:"red",extra:[{score:{name:"@s",objective:"guidebook"}},"!"]}]
