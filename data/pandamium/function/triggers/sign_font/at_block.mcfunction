...
execute unless score <line> variable matches 1..5 run return run tellraw @s [{text:"[Sign Font]",color:"dark_red"},{text:" That is not a valid option!",color:"red"}]
...
execute if score <all_lines> variable matches 1 run return 0
execute if score <valid_option> variable matches 0 run return run tellraw @s [{text:"[Sign Font]",color:"dark_red"},{text:" That is not a valid option!",color:"red"}]
execute if score <lines_changed> variable matches 0 run return run tellraw @s [{text:"[Sign Font]",color:"dark_red"},{text:" Nothing changed!",color:"red"}]
# success
