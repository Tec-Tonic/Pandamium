...
execute unless data storage pandamium:temp display_name run data modify storage pandamium:temp display_name set value [{color:"red",text:"<Invalid Username: "},{storage:"pandamium:local",nbt:'functions."pandamium:triggers/search_players/click_events/search_names/loop".username',interpret:true},">"]
