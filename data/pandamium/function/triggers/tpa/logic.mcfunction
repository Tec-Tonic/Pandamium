...
# close menu
execute if score @s tpa matches -101 run return run dialog show @s pandamium:options
# menu
...
execute if score @s tpa matches -102 run return run function pandamium:impl/tpa/accept_incoming_request/main
execute if score @s tpa matches -2 run return run function pandamium:impl/tpa/deny_incoming_request/main
execute if score @s tpa matches -103 run return run function pandamium:impl/tpa/deny_incoming_request/main
execute if score @s tpa matches -3 run return run function pandamium:impl/tpa/cancel_outgoing_request/main
execute if score @s tpa matches -104 run return run function pandamium:impl/tpa/cancel_outgoing_request/main
