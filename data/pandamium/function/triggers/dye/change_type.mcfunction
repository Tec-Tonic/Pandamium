...
execute if score <chosen_type> variable matches 4..5 if score @s custom_dye.type = <chosen_type> variable if score <colors_changed> variable matches 0 run return run tellraw @s [{text:"[Dye]",color:"dark_red"},{text:" Nothing changed! Your dye is already set to that colour!",color:"red"}]
...
# update armour
execute if items entity @s armor.feet #pandamium:leather_player_armor[custom_data~{pandamium:{transient_equippable:{}}}] run item modify entity @s armor.feet {type:"minecraft:set_components",components:{"!minecraft:dyed_color":{}}}
execute if items entity @s armor.legs #pandamium:leather_player_armor[custom_data~{pandamium:{transient_equippable:{}}}] run item modify entity @s armor.legs {type:"minecraft:set_components",components:{"!minecraft:dyed_color":{}}}
execute if items entity @s armor.chest #pandamium:leather_player_armor[custom_data~{pandamium:{transient_equippable:{}}}] run item modify entity @s armor.chest {type:"minecraft:set_components",components:{"!minecraft:dyed_color":{}}}
execute if items entity @s armor.head #pandamium:leather_player_armor[custom_data~{pandamium:{transient_equippable:{}}}] run item modify entity @s armor.head {type:"minecraft:set_components",components:{"!minecraft:dyed_color":{}}}
