...
execute unless score <unavailable> variable matches 1 unless data storage pandamium.db.stored_items:io selected run function pandamium:triggers/mail/click_events/take_incoming_items/missing_stored_item
execute unless score <unavailable> variable matches 1 unless data storage pandamium.db.stored_items:io selected run scoreboard players set <unavailable> variable 1
