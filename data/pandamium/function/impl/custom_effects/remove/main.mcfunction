...
execute unless data storage pandamium.db.players:io selected.entry.data.custom_effects[0] run data remove storage pandamium.db.players:io selected.entry.data.custom_effects
# reset attributes and other effects
$scoreboard players reset @s custom_effects.has_effect.$(name)
execute if data storage pandamium:temp custom_effect_entry.data.attribute_modifiers[0] run data modify storage pandamium:temp custom_effect_entry.data.attribute_modifiers[].custom_effect_name set from storage pandamium:temp custom_effect_entry.meta.name
execute if data storage pandamium:temp custom_effect_entry.data.attribute_modifiers[0] run function pandamium:impl/custom_effects/remove/attribute_modifiers_loop
# reset listeners
