...
tellraw @a[scores={voting_summary_buffer=..0},predicate=pandamium:player/gameplay_rank/guest] [{text:"Run ",color:"gray",hover_event:{action:"show_text",value:{text:"Click to open the Rewards Shop",color:"aqua"}},click_event:{action:"run_command",command:"trigger rewards_shop"}},{text:"/trigger rewards_shop",color:"aqua"}," to spend your reward credits!"]
