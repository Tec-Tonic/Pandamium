execute on vehicle unless predicate {type:"minecraft:entity_properties",entity:"this",predicate:{components:{"minecraft:custom_name":{translate:"entity.pandamium.flying_eyeball",fallback:"Flying Eyeball"}}}} run data modify entity @s CustomName set value {translate:"entity.pandamium.flying_eyeball",fallback:"Flying Eyeball"}
