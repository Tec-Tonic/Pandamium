...
execute if entity @s[type=item_display,tag=pandamium.custom_entity.type.defused_wither_skull] run function pandamium:impl/custom_entities/custom_entity_types/defused_wither_skull/tick
