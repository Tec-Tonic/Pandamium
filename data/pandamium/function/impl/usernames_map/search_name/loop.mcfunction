...
execute unless data storage pandamium:temp command_parts{1:""} run function pandamium:impl/usernames_map/search_name/append_command_part with storage pandamium:templates macro.index__value
data modify storage pandamium:templates macro.index__value.value set value "[{character:\\\""
function pandamium:impl/usernames_map/search_name/append_command_part with storage pandamium:templates macro.index__value
data modify storage pandamium:templates macro.character.character set string storage pandamium:temp this_username 0 1
function pandamium:impl/usernames_map/search_name/lowercaseify with storage pandamium:templates macro.character
...
execute unless data storage pandamium:temp {this_username:""} run return run function pandamium:impl/usernames_map/search_name/loop
