...
# resolve source
execute unless function pandamium:impl/punishment/unjail/source/resolve run return run function pandamium:utils/log_exception {args:{function:"pandamium:impl/punishment/unjail/main",message:['Invalid source: ',{storage:"pandamium:local",nbt:'functions."pandamium:impl/punishment/unjail/*".source',interpret:true}]}}
...
execute if score <valid_source> variable matches 0 run return run function pandamium:utils/log_exception {args:{function:"pandamium:impl/punishment/unjail/main",message:['Invalid source type: ',{storage:"pandamium:local",nbt:'functions."pandamium:impl/punishment/unjail/*".source.target',interpret:true}]}}
# try unjail
...
# log & announce
execute unless score <announce> variable matches 1 run function pandamium:utils/log {args:{message:['event="unjail",data={"username":"',{storage:"pandamium:local",nbt:'functions."pandamium:impl/punishment/unjail/*".target',interpret:true},'","announce":false,"source":',{storage:"pandamium:local",nbt:'functions."pandamium:impl/punishment/unjail/*".log_source_json',interpret:true},'}']}}
execute if score <announce> variable matches 1 run function pandamium:utils/log {args:{message:['event="unjail",data={"username":"',{storage:"pandamium:local",nbt:'functions."pandamium:impl/punishment/unjail/*".target',interpret:true},'","announce":true,"source":',{storage:"pandamium:local",nbt:'functions."pandamium:impl/punishment/unjail/*".log_source_json',interpret:true},'}']}}
