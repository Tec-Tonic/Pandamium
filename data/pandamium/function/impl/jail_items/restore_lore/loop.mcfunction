...
execute if data storage pandamium:temp items_in[-1].components."minecraft:custom_data".pandamium.jail_item.stored_lore run data modify storage pandamium:temp items_in[-1].components."minecraft:lore" set from storage pandamium:temp items_in[-1].components."minecraft:custom_data".pandamium.jail_item.stored_lore
execute unless data storage pandamium:temp items_in[-1].components."minecraft:custom_data".pandamium.jail_item.stored_lore if data storage pandamium:temp items_in[-1].components."minecraft:custom_data".pandamium.stored_lore run data modify storage pandamium:temp items_in[-1].components."minecraft:lore" set from storage pandamium:temp items_in[-1].components."minecraft:custom_data".pandamium.stored_lore
...
execute if data storage pandamium:temp items_in[0] run function pandamium:impl/jail_items/restore_lore/loop
