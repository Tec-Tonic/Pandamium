...
item modify entity @s contents {type:"minecraft:set_custom_data",tag:{pandamium:{jail_item:{}}}}
...
item modify entity @s contents {type:"minecraft:set_lore",entity:"this",lore:[{nbt:"functions.'pandamium:impl/jail_items/*'.lore[0]",storage:"pandamium:local",interpret:true},{nbt:"functions.'pandamium:impl/jail_items/*'.lore[1]",storage:"pandamium:local",interpret:true},{nbt:"functions.'pandamium:impl/jail_items/*'.lore[2]",storage:"pandamium:local",interpret:true}],mode:"append"}
