...
execute if predicate {type:"minecraft:location_check",predicate:{position:{y:{min:320}}}} run return run loot spawn 6.0 64.0 3.0 mine 2 0 0 barrier[custom_data={drop_contents:true}]
