...
execute if predicate pandamium:player/supporter_rank/true run scoreboard players set @s gameplay_perms 6
execute if predicate pandamium:player/vip_rank/true run scoreboard players set @s gameplay_perms 6
# home perms
...
execute if predicate pandamium:player/min_gameplay_perms/supporter run scoreboard players set @s available_homes 25
