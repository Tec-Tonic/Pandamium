...
execute if predicate {type:"minecraft:int_value_check",value:{type:"storage",storage:"pandamium:queue",path:"selected.entry.meta.max"},test:{max:0}} run data modify storage pandamium:queue selected.entry.meta.max set value 1
execute if predicate {type:"minecraft:int_value_check",value:{type:"storage",storage:"pandamium:queue",path:"selected.entry.meta.value"},test:{max:-1}} run data modify storage pandamium:queue selected.entry.meta.value set value 0
execute if predicate {type:"minecraft:int_value_check",value:{type:"storage",storage:"pandamium:queue",path:"selected.entry.meta.value"},test:{min:{type:"storage",storage:"pandamium:queue",path:"selected.entry.meta.max"}}} run data modify storage pandamium:queue selected.entry.meta.value set from storage pandamium:queue selected.entry.meta.max
