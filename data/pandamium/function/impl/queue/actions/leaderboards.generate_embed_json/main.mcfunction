...
# flatten
data modify storage do:io input set from storage pandamium:queue selected.entry.components[0]
...
execute in pandamium:staff_world run data modify block 3 0 0 front_text.messages set value [{storage:"pandamium:queue",nbt:"selected.entry.output",interpret:true},{storage:"do:io",nbt:"output",interpret:true},"",""]
...
# once done
execute in pandamium:staff_world run data modify block 3 0 0 front_text.messages[0] set value {storage:"pandamium:queue",nbt:"selected.entry.output",interpret:true}
