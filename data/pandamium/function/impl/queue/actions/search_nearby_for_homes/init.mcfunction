...
execute in pandamium:staff_world positioned 0. 0 0. summon marker if function pandamium:utils/discard_marker run data modify storage pandamium:local functions."pandamium:impl/queue/actions/search_nearby_for_homes/init".uuid set from entity @s UUID
