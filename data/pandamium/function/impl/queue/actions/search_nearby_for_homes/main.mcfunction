...
$execute unless data storage pandamium:queue selected.entry.homes[0] run return run tellraw @a[scores={id=$(source)},limit=1] {color:"red",text:"No homes were found within 500 blocks horizontally of ",extra:[{color:"yellow",text:"",extra:[{storage:"pandamium:queue",nbt:"selected.entry.origin.x"},{text:" ~ "},{storage:"pandamium:queue",nbt:"selected.entry.origin.z"}]},{text:" in "},{storage:"pandamium:queue",nbt:"selected.entry.origin.dimension",interpret:true,color:"yellow"},{text:"!"}]}
# process top entry
...
$execute if data storage pandamium:queue selected.entry{homes_found:0} run return run tellraw @a[scores={id=$(source)},limit=1] {color:"red",text:"No homes were found within 500 blocks horizontally of ",extra:[{color:"yellow",text:"",extra:[{storage:"pandamium:queue",nbt:"selected.entry.origin.x"},{text:" ~ "},{storage:"pandamium:queue",nbt:"selected.entry.origin.z"}]},{text:" in "},{storage:"pandamium:temp",nbt:"dimension_name",interpret:true,color:"yellow"},{text:"!"}]}
$tellraw @a[scores={id=$(source)},limit=1] {color:"green",text:"",extra:[{storage:"pandamium:queue",nbt:"selected.entry.homes_found",color:"aqua"}," homes were found within 500 blocks horizontally of ",{color:"aqua",text:"",extra:[{storage:"pandamium:queue",nbt:"selected.entry.origin.x"}," ~ ",{storage:"pandamium:queue",nbt:"selected.entry.origin.z"}]}," in ",{storage:"pandamium:temp",nbt:"dimension_name",interpret:true,color:"aqua"},"!"]}
