...
execute in minecraft:the_end positioned 100 48 0 unless predicate {type:"minecraft:all_of",terms:[{type:"minecraft:location_check",predicate:{block:{blocks:"minecraft:bedrock"}}},{type:"minecraft:location_check",offsetY:1,predicate:{block:{blocks:"minecraft:moving_piston"}}},{type:"minecraft:location_check",offsetY:2,predicate:{block:{blocks:"minecraft:moving_piston"}}}]} run function pandamium:utils/log {args:{tell_online:true,message:["Regenerated end platform and teleported ",{selector:"@s"}," safely"]}}
# regenerate platform
