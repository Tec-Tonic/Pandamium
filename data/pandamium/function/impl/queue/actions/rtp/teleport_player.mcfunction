...
execute positioned ~ ~1 ~ unless predicate {type:"minecraft:location_check",predicate:{light:{light:15}}} run particle minecraft:firefly ~ ~0.5 ~ 0.5 0 0.5 0 10 force @s
execute positioned ~ ~1 ~ unless predicate {type:"minecraft:location_check",predicate:{light:{light:15}}} run function pandamium:misc/summon/fading_glow
