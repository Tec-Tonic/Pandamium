...
execute if predicate {type:"minecraft:int_value_check",value:{type:"storage",storage:"pandamium:queue",path:"selected.entry.age"},test:{min:{type:"storage",storage:"pandamium:queue",path:"selected.entry.duration"}}} run return 0
...
execute if predicate {type:"minecraft:int_value_check",value:{type:"storage",storage:"pandamium:queue",path:"selected.entry.age"},test:{max:0}} run data modify storage pandamium:queue selected.entry.age set value 1
