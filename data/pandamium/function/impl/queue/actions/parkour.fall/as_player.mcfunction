...
execute if score @s parkour.checkpoint matches 300 run particle minecraft:block_crumble{block_state:"pale_oak_log"} ~ ~1 ~ 0.3 1 0.3 0 100
...
execute if score @s parkour.checkpoint matches 303..304 run particle minecraft:lava ~ ~ ~ 0 0 0 1 10
