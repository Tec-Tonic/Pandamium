# arguments: username
$summon area_effect_cloud ~ ~ ~ {Radius:0,custom_particle:{type:"minecraft:block",block_state:{id:"minecraft:air"}},CustomName:[{color:"red",text:"☠ "},{bold:true,text:"$(username)"}," ☠"],CustomNameVisible:1b,WaitTime:12000,Tags:["parkour.death_point","spawn_protected"]}
