...
execute store result storage pandamium.db.players:io selected.entry.data.parkour.course_4.fewest_falls.finish_datetime int 1 run function pandamium:utils/datetime/get_current_datetime_id
