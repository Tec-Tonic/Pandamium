...
#
execute if score <spawn_area_ticking_state> global matches 1 at @e[type=marker,tag=parkour.node,tag=parkour.start] run particle minecraft:falling_dust{block_state:"minecraft:diamond_block"} ~ ~0.5 ~ 0 0 0 0 1
