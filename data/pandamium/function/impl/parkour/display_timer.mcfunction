...
#
execute if score <timer_hours> variable matches 0 run title @s actionbar [{text:"Parkour: ",color:"dark_aqua"},{storage:"pandamium:temp",nbt:"parts[0]",interpret:true,color:"aqua",extra:[{score:{name:"<timer_minutes>",objective:"variable"}}]},":",{storage:"pandamium:temp",nbt:"parts[1]",interpret:true,color:"aqua",extra:[{score:{name:"<timer_seconds>",objective:"variable"}}]}," | ",{text:"/trigger ",color:"gray"},{text:"parkour",color:"aqua"}]
execute if score <timer_hours> variable matches 1.. run title @s actionbar [{text:"Parkour: ",color:"dark_aqua"},{score:{name:"<timer_hours>",objective:"variable"},color:"aqua"},":",{storage:"pandamium:temp",nbt:"parts[0]",interpret:true,color:"aqua",extra:[{score:{name:"<timer_minutes>",objective:"variable"}}]},":",{storage:"pandamium:temp",nbt:"parts[1]",interpret:true,color:"aqua",extra:[{score:{name:"<timer_seconds>",objective:"variable"}}]}," | ",{text:"/trigger ",color:"gray"},{text:"parkour",color:"aqua"}]
