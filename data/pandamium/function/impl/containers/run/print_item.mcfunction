...
# else:
tellraw @s ["",{nbt:"slot_prefix",storage:"pandamium:containers",interpret:true,color:"aqua",underlined:true,font:"uniform",extra:[{score:{name:"<display_slot>",objective:"variable"}}]},": ",{score:{name:"<count>",objective:"variable"},color:"gold"}," ",{nbt:"item.display_id",storage:"pandamium:containers",interpret:true,color:"yellow"},{nbt:"plural",storage:"pandamium:containers",interpret:true,color:"gray"}]
