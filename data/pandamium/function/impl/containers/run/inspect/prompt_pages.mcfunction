...
data modify storage pandamium:containers inspect.prompt set value {prefix:{text:"└pages: ",color:"aqua"},body:{text:"[See Pages]",color:"blue"},suffix:"",body_inspection_description:[{text:"x",color:"gray"},{score:{name:"<total_pages>",objective:"variable"}},{text:" Pages"}]}
