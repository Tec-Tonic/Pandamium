# copy to custom component
data modify storage pandamium:containers item.components."pandamium:custom_item_id" set from storage pandamium:containers item.components."minecraft:custom_data".pandamium.id
# replace ID
...
execute if data storage pandamium:containers item.components{"pandamium:custom_item_id":"bedrock_breaker"} run data remove storage pandamium:containers item.components."minecraft:enchantment_glint_override"
execute if data storage pandamium:containers item.components{"pandamium:custom_item_id":"bedrock_breaker"} run data remove storage pandamium:containers item.components."minecraft:item_model"
execute if data storage pandamium:containers item.components{"pandamium:custom_item_id":"bedrock_breaker"} run data remove storage pandamium:containers item.components."minecraft:max_damage"
...
execute if data storage pandamium:containers item.components{"pandamium:custom_item_id":"dork_feather"} run data remove storage pandamium:containers item.components."!minecraft:max_damage"
execute if data storage pandamium:containers item.components{"pandamium:custom_item_id":"dork_feather"} run data remove storage pandamium:containers item.components."minecraft:dyed_color"
...
execute if data storage pandamium:containers item.components{"pandamium:custom_item_id":"endermite_minecart"} run data remove storage pandamium:containers item.components."minecraft:enchantment_glint_override"
...
execute if data storage pandamium:containers item.components{"pandamium:custom_item_id":"stored_mob"} run data modify storage pandamium:containers item.components."minecraft:custom_data".pandamium.stored_mob_id set from storage pandamium:containers item.components."minecraft:custom_data".pandamium.stored_mob.id
execute if data storage pandamium:containers item.components{"pandamium:custom_item_id":"stored_mob"} run data remove storage pandamium:containers item.components."minecraft:custom_data".pandamium.stored_mob
execute if data storage pandamium:containers item.components{"pandamium:custom_item_id":"stored_mob"} run data modify storage pandamium:containers item.components."minecraft:custom_data".pandamium.stored_mob.id set from storage pandamium:containers item.components."minecraft:custom_data".pandamium.stored_mob_id
