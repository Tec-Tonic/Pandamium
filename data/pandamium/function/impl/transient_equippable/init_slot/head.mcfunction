...
execute if items block 5 0 0 contents leather_helmet[!equippable|equippable={equip_sound:"minecraft:item.armor.equip_leather",asset_id:"minecraft:leather",slot:"head"}] run item modify block 5 0 0 contents {type:"minecraft:set_components",components:{"minecraft:equippable":{dispensable:false,equip_sound:"minecraft:intentionally_empty",asset_id:"minecraft:leather",slot:"head"}}}
