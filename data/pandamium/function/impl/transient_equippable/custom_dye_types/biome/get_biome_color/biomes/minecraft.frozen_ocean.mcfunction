...
scoreboard players set @s custom_dye.biome_id 22
scoreboard players set @s custom_dye.color_transition.target_red 57
scoreboard players set @s custom_dye.color_transition.target_green 56
scoreboard players set @s custom_dye.color_transition.target_blue 201
