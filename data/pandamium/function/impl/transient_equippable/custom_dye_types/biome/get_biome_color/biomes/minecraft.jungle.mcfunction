...
scoreboard players set @s custom_dye.biome_id 28
scoreboard players set @s custom_dye.color_transition.target_red 48
scoreboard players set @s custom_dye.color_transition.target_green 187
scoreboard players set @s custom_dye.color_transition.target_blue 11
