...
scoreboard players set @s custom_dye.biome_id 20
scoreboard players set @s custom_dye.color_transition.target_red 89
scoreboard players set @s custom_dye.color_transition.target_green 174
scoreboard players set @s custom_dye.color_transition.target_blue 48
