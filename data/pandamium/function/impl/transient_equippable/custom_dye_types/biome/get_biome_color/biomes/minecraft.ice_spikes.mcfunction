...
scoreboard players set @s custom_dye.biome_id 26
scoreboard players set @s custom_dye.color_transition.target_red 133
scoreboard players set @s custom_dye.color_transition.target_green 173
scoreboard players set @s custom_dye.color_transition.target_blue 248
