...
scoreboard players set @s custom_dye.biome_id 39
scoreboard players set @s custom_dye.color_transition.target_red 119
scoreboard players set @s custom_dye.color_transition.target_green 130
scoreboard players set @s custom_dye.color_transition.target_blue 114
