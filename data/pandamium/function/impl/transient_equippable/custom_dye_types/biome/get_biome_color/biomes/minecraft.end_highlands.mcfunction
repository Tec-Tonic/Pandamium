...
scoreboard players set @s custom_dye.biome_id 17
scoreboard players set @s custom_dye.color_transition.target_red 222
scoreboard players set @s custom_dye.color_transition.target_green 230
scoreboard players set @s custom_dye.color_transition.target_blue 164
