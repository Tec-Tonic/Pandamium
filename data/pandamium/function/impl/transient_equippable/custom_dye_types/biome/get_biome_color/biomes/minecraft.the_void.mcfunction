...
scoreboard players set @s custom_dye.biome_id 57
scoreboard players set @s custom_dye.color_transition.target_red 0
scoreboard players set @s custom_dye.color_transition.target_green 0
