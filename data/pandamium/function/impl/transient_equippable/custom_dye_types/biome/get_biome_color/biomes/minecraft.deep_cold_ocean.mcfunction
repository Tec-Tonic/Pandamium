...
scoreboard players set @s custom_dye.biome_id 9
scoreboard players set @s custom_dye.color_transition.target_red 61
scoreboard players set @s custom_dye.color_transition.target_green 87
scoreboard players set @s custom_dye.color_transition.target_blue 214
