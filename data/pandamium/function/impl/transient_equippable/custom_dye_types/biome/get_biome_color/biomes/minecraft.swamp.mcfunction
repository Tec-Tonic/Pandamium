...
scoreboard players set @s custom_dye.biome_id 54
scoreboard players set @s custom_dye.color_transition.target_red 106
scoreboard players set @s custom_dye.color_transition.target_green 112
scoreboard players set @s custom_dye.color_transition.target_blue 57
