...
scoreboard players set @s custom_dye.biome_id 43
scoreboard players set @s custom_dye.color_transition.target_red 174
scoreboard players set @s custom_dye.color_transition.target_green 164
scoreboard players set @s custom_dye.color_transition.target_blue 42
