...
scoreboard players set @s custom_dye.biome_id 49
scoreboard players set @s custom_dye.color_transition.target_red 73
scoreboard players set @s custom_dye.color_transition.target_green 55
scoreboard players set @s custom_dye.color_transition.target_blue 44
