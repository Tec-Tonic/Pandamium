...
scoreboard players set @s custom_dye.biome_id 29
scoreboard players set @s custom_dye.color_transition.target_red 69
scoreboard players set @s custom_dye.color_transition.target_green 173
scoreboard players set @s custom_dye.color_transition.target_blue 242
