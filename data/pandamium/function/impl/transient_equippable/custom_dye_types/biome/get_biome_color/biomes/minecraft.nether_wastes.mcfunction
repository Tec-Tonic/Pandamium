...
scoreboard players set @s custom_dye.biome_id 34
scoreboard players set @s custom_dye.color_transition.target_red 114
scoreboard players set @s custom_dye.color_transition.target_green 50
scoreboard players set @s custom_dye.color_transition.target_blue 50
