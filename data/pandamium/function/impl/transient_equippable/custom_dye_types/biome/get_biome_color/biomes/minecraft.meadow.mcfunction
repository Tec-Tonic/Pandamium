...
scoreboard players set @s custom_dye.biome_id 32
scoreboard players set @s custom_dye.color_transition.target_red 99
scoreboard players set @s custom_dye.color_transition.target_green 169
scoreboard players set @s custom_dye.color_transition.target_blue 72
