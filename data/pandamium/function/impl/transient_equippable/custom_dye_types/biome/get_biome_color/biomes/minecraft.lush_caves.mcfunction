...
scoreboard players set @s custom_dye.biome_id 30
scoreboard players set @s custom_dye.color_transition.target_red 113
scoreboard players set @s custom_dye.color_transition.target_green 167
scoreboard players set @s custom_dye.color_transition.target_blue 77
