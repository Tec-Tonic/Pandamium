...
scoreboard players set @s custom_dye.biome_id 19
scoreboard players set @s custom_dye.color_transition.target_red 180
scoreboard players set @s custom_dye.color_transition.target_green 95
scoreboard players set @s custom_dye.color_transition.target_blue 28
