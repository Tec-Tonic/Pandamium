...
scoreboard players set @s custom_dye.biome_id 50
scoreboard players set @s custom_dye.color_transition.target_red 62
scoreboard players set @s custom_dye.color_transition.target_green 184
scoreboard players set @s custom_dye.color_transition.target_blue 15
