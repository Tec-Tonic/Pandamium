...
scoreboard players set @s custom_dye.biome_id 65
scoreboard players set @s custom_dye.color_transition.target_red 236
scoreboard players set @s custom_dye.color_transition.target_green 148
scoreboard players set @s custom_dye.color_transition.target_blue 0
