...
scoreboard players set @s custom_dye.biome_id 10
scoreboard players set @s custom_dye.color_transition.target_red 14
scoreboard players set @s custom_dye.color_transition.target_green 34
scoreboard players set @s custom_dye.color_transition.target_blue 54
