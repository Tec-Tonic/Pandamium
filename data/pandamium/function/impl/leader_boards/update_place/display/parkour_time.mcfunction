...
data modify storage do:io input set value [{color:"green",text:""},{bold:true,score:{name:"<seconds_padding>",objective:"variable"},extra:[{score:{name:"<seconds>",objective:"variable"}}]},{color:"dark_green",text:"."}]
execute if score <value> variable >= #ticks_per_minute constant run data modify storage do:io input insert 1 value {bold:true,score:{name:"<minutes_padding>",objective:"variable"},extra:[{score:{name:"<minutes>",objective:"variable"}},{bold:false,text:":"}]}
execute if score <value> variable >= #ticks_per_hour constant run data modify storage do:io input insert 1 value {bold:true,score:{name:"<hours>",objective:"variable"},extra:[{bold:false,text:":"}]}
...
data modify storage do:io input[-1].extra append from storage pandamium:temp subscript_digit
...
function pandamium:utils/get/subscript_digit with storage pandamium:local functions."pandamium:impl/leader_boards/update_place/display/parkour_time"
data modify storage do:io input[-1].extra append from storage pandamium:temp subscript_digit
execute if score <value> variable < #ticks_per_minute constant run data modify storage do:io input append value " seconds"
