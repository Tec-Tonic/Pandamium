...
data modify storage do:io input set value [{color:"green",text:""},{bold:true,score:{name:"<hours>",objective:"variable"}},"h, ",{bold:true,score:{name:"<minutes>",objective:"variable"}},"m"]
