...
$function pandamium:impl/dynamic_triggers/add_alias_target/main {alias:"home.$(plain_name)",trigger_name:"home",target_selector:"$(user_name)",trigger_value:$(home_slot)}
