...
execute as @a[scores={help=-2147483648..}] unless score @s help matches 0 run function pandamium:triggers/help/main
...
execute as @a[scores={vote=..-1}] at @s run function pandamium:triggers/vote/main
execute as @a[scores={rewards_shop=1..}] at @s run function pandamium:triggers/rewards_shop/main
execute as @a[scores={rewards_shop=..-1}] at @s run function pandamium:triggers/rewards_shop/main
...
execute as @a[scores={take_inventory=..-1}] at @s run function pandamium:triggers/take_inventory/main
execute as @a[scores={report=1..}] at @s run function pandamium:triggers/report/main
#> Post
