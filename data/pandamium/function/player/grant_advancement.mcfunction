...
$execute store result storage pandamium:templates macro.index__advancement.index int 1 run data get storage pandamium.db.players:data username_indexes."$(username)"
