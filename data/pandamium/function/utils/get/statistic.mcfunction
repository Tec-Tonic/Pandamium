...
$execute if predicate {type:"minecraft:entity_properties",entity:"this",predicate:{"minecraft:type_specific/player":{stats:[{type:"$(type)",stat:"$(stat)",value:0}]}}} run return 0
