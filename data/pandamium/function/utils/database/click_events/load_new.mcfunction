...
execute store result storage pandamium:templates macro.click_event_id.click_event_id int 1 store result storage pandamium.db.click_events:io selected.entry.click_event_id int 1 store result storage pandamium.db.click_events:data last_click_event_id int 1 run scoreboard players add <click_event_id> variable 1
# set index
...
data modify storage pandamium.db.click_events:data entries append from storage pandamium.db.click_events:io selected.entry
