# arguments: trigger
$data modify storage pandamium.db.click_events:io selected.entry.trigger set value "$(trigger)"
$data modify storage pandamium:templates macro.trigger__value.trigger set value "$(trigger)"
execute store result score <click_event_root_value> variable run data get storage pandamium.db.click_events:io selected.entry.click_event_id
