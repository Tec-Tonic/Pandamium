...
execute unless data storage pandamium:local functions."pandamium:utils/log".args{disable_prefix:true} run data modify storage do:io input set value ["[Pandamium] ",{storage:"pandamium:local",nbt:'functions."pandamium:utils/log".args.message',interpret:true}]
execute if data storage pandamium:local functions."pandamium:utils/log".args{disable_prefix:true} run data modify storage do:io input set value {storage:"pandamium:local",nbt:'functions."pandamium:utils/log".args.message',interpret:true}
