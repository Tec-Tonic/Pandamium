...
execute unless items entity @s armor.legs * run return 0
...
data modify storage pandamium.db.mail:io selected.entry.data.message set value "Your inventory was too full to unequip the item that you were wearing in your legs slot.\n\nThe item has been safely moved here for you to reclaim later."
