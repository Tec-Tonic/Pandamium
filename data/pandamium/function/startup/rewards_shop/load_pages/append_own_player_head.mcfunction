...
$data modify storage pandamium:rewards_shop dialogs.$(dialog_name).dialog.body[-1].description[2][1].hover_event.value append from storage pandamium:rewards_shop rewards[{reward_id:"own_player_head"}].name
$data modify storage pandamium:rewards_shop dialogs.$(dialog_name).dialog.body[-1].description[2][1].extra prepend string storage pandamium:rewards_shop rewards[{reward_id:"own_player_head"}].cost
